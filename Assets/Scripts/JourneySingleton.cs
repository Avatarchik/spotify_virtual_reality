...
public class JourneySingleton : Singleton<JourneySingleton>  {
	...
	protected JourneySingleton() {
		...
		addPlace ("Islandia", 75, 190, defaultSongTime, "Skógafoss", "Islândia", "Elephant Gun", "Beirut", "#808A24");
		...
		addPlace ("Congo", 105, 0, defaultSongTime, "Parque Nacional Queen Elizabeth", "Uganda", "African Drums", "african tribal orchestra", "#b19ab1", true);
		addPlace ("Victoria", 0, 0, defaultSongTime, "Victoria Falls", "Zâmbia", "Zombie", "Fela Kuti", "#7c7b30");
